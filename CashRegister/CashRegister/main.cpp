					...
					do
					{
						...
						if (schoice[1] == "1" || schoice[1] == "2" || schoice[1] == "3")
						{
							...
							if (schoice[1] == "2")
							{
								...
								cout << std::setw(31) << "Sales Tax" << "$" << std::fixed << std::setprecision(2) << cart->getTotalTax(myDB->getTax()) << endl;
								cout << std::setw(31) << "Total cost" << "$" << setprecision(2) << fixed << cart->getTotalCost(myDB->getTax()) << endl;
